...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonCamera.setMaximumSize(QtCore.QSize(16777215, 40))
        self.buttonCamera.setObjectName(_fromUtf8("buttonCamera"))
        self.horizontalLayout_10.addWidget(self.buttonCamera)
        ...
        self.buttonSurveillance.setMaximumSize(QtCore.QSize(16777215, 40))
        self.buttonSurveillance.setObjectName(_fromUtf8("buttonSurveillance"))
        self.horizontalLayout_10.addWidget(self.buttonSurveillance)
        self.verticalLayout_5.addLayout(self.horizontalLayout_10)
        self.horizontalLayoutCamera = QtGui.QHBoxLayout()
        self.horizontalLayoutCamera.setObjectName(_fromUtf8("horizontalLayoutCamera"))
        self.verticalLayout_5.addLayout(self.horizontalLayoutCamera)
        self.verticalLayout_5.setStretch(1, 1)
        self.verticalLayout_2.addLayout(self.verticalLayout_5)
        self.subwindowOptions = QtGui.QWidget()
        self.subwindowOptions.setObjectName(_fromUtf8("subwindowOptions"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.subwindowOptions)
        self.verticalLayout_3.setMargin(0)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.horizontalLayout = QtGui.QHBoxLayout()
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.label_2 = QtGui.QLabel(self.subwindowOptions)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout.addWidget(self.label_2)
        self.lineEmail = QtGui.QLineEdit(self.subwindowOptions)
        ...
        self.labelPassword = QtGui.QLabel(self.subwindowOptions)
        self.labelPassword.setObjectName(_fromUtf8("labelPassword"))
        self.horizontalLayout_2.addWidget(self.labelPassword)
        self.linePassword = QtGui.QLineEdit(self.subwindowOptions)
        ...
        self.labelMinutesEmails = QtGui.QLabel(self.subwindowOptions)
        ...
        self.lineMinutesEmails = QtGui.QLineEdit(self.subwindowOptions)
        ...
        self.buttonApply = QtGui.QPushButton(self.subwindowOptions)
